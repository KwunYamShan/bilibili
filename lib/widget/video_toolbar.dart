...
class VideoToolbar extends StatelessWidget {
  ...
  const VideoToolbar({Key? key,this.detailMo,required this.videoModel, this.onLike, this.onUnLike, this.onFavorite, this.onCoin, this.onShare}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildIconText(Icons.thumb_up_alt_rounded,videoModel.like,onClick: onLike,tint: detailMo?.isLike??false),
          ...
          _buildIconText(Icons.grade_rounded,videoModel.favorite,onClick: onFavorite,tint: detailMo?.isFavorite??false),
